...
(defvar sunburn-diff-add-background "#FDD")
(defvar sunburn-diff-del-background "#DFD")
(defvar sunburn-hunk-header-foreground sunburn-blue)
(defvar sunburn-none-foreground sunburn-green)
...
(defun color-theme-sunburn ()
  ...
  (color-theme-install
	...
	`(mew-face-eof-part ((t (:inherit sunburn-green))))
        ...
        `(magit-diff-add ((t (:background ,sunburn-diff-add-background :foreground ,sunburn-fg))))
        `(magit-diff-del ((t (:background ,sunburn-diff-del-background :foreground ,sunburn-fg))))
